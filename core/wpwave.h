...
public:
    ...
    template <class Type> void Gabor(const Type *begin, const Type *end, double sigma, int period, QVector<QVector<std::complex<double> > > &out);
    void _Gabor(QVector<QVector<std::complex<double> > > &in, double sigma, int period, QVector<std::complex<double> > &out);
    ...
    void FFT();
    void _FFT();
    void STFT(double sigma, int period);
    void _STFT(double sigma, int period);
